...
<section class="book-form" id="book-form">
    ...
    <form method="POST">
        ...
        <div>
        <input data-aos="zoom-in" data-aos-delay="600" type="submit" name="book" value="Book now" class="btn"/>
        </div>
        ...
        <?php
                    ...
                    if(isset($_POST["book"]))
                    {
                        ...
                        $travelers = $_POST['travelers'];
                            ...
                            $query = "INSERT INTO `book` (`name`, `email`,`phone`, `address`, `location`,`date`, `travelers`) VALUES ('{$name}',  '{$email}','{$phone}',  '{$address}',  '{$location}','{$date}',  '{$travelers}');";
